...
#this plot is not showes the decision regions because in X we have n_number of variables
...
# compared to all kernel the Radial basis function is providing the best results by comparing with two data set accuracy_score
